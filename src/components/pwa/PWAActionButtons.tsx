  ...
  const actions = [
    {
      id: 'create',
      icon: Users,
      label: t('createGame', 'Créer une partie'),
      description: t('hostDescription', 'Invitez vos amis'),
    ...
    },
    {
      id: 'join',
      icon: UserPlus,
      label: t('joinGame', 'Rejoindre'),
      description: t('joinDescription', 'Entrez un code'),
      onClick: onJoinRoom,
    ...
    },
    {
      id: 'solo',
      icon: User,
      label: t('soloMode', 'Mode Solo'),
      description: t('soloDescription', 'Jouez seul'),
      onClick: onSoloMode,
