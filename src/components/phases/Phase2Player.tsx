        ...
        <div className="fixed inset-0 flex overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center p-4 pointer-events-none">
                                    ...
                                    <div className={`p-6 rounded-2xl shadow-2xl border-4 ${didIWin
                                        ...
                                        {!didIWin && currentItem && (
                                            <div className="text-sm mt-2 text-red-400">
                                                ...
                                                {currentItem.acceptedAnswers && currentItem.acceptedAnswers.length > 1 && (
                                                    <span className="text-red-300 text-xs block mt-1">
                                                        {t('phase2.alsoAccepted')}: {
                                                            currentItem.acceptedAnswers
                                                                .filter(a => a !== currentItem.answer)
                                                                .map(a => a === 'A' ? currentSet.optionA : a === 'B' ? currentSet.optionB : t('phase2.optionBoth'))
                                                                .join(', ')
                                                        }
                                                    </span>
                                                )}
                ...
                >
                    ...
                    {/* Answer Label Badge (shows only during result phase to avoid spoiler) */}
                    {isRoundOver && hasAnswered && currentItem && (
                        <motion.div
