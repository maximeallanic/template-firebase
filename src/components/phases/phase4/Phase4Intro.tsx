...
import { type Room, nextPhase4Question } from '../../../services/gameService';
import { FileQuestion, Clock, Zap, Trophy } from 'lucide-react';
            ...
            >
                ...
                {isHost ? (
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        onClick={handleStart}
                        className="bg-gradient-to-r from-purple-600 to-purple-500 text-white px-12 py-5 rounded-2xl text-2xl font-black shadow-2xl uppercase tracking-wider"
                    >
                        {t('common:buttons.start')}
                    </motion.button>
                ) : (
                    <div className="animate-pulse text-purple-500/50 text-xl font-bold uppercase tracking-widest">
