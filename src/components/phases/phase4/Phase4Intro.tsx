        ...
        <div className="flex flex-col items-center justify-center min-h-full p-4 md:p-8 text-white bg-gradient-to-br from-slate-900 via-slate-800 to-black">
            ...
            >
                ...
                <div className="mb-2 md:mb-8">
                    <FileQuestion className="w-10 h-10 md:w-20 md:h-20 text-purple-500 mx-auto mb-1 md:mb-4 drop-shadow-[0_0_15px_rgba(168,85,247,0.5)]" />
                    <h1 className="text-2xl md:text-5xl lg:text-7xl font-black uppercase tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-purple-300 to-purple-600">
                        {t('phase4Intro.title')}
                    </h1>
                    <p className="hidden md:block mt-4 text-xl text-slate-400">{t('phase4Intro.subtitle')}</p>
                </div>

                {/* Rules */}
                <div className="bg-slate-800/60 backdrop-blur-sm rounded-2xl md:rounded-3xl p-2 md:p-8 mb-2 md:mb-8 border border-white/10">
                    <h2 className="hidden md:block text-2xl font-bold mb-6 text-purple-400">{t('phase4Intro.howToPlay')}</h2>
