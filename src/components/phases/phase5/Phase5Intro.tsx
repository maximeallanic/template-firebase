...
import { Gamepad2, Brain, Users, Trophy, Check, Loader2 } from 'lucide-react';
            ...
            >
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    {isHost && isPlayerReady && (
                        <motion.button
                            whileHover={allReady ? { scale: 1.05, boxShadow: "0 0 30px rgba(234,179,8,0.4)" } : {}}
                        ...
                        >
                            {allReady ? t('phase5.startVoting') : t('phase1Intro.waitingForPlayers')}
                        </motion.button>
                    )}
                </div>
            </motion.div>
