...
/**
 * Prompt for dedicated fact-checking of generated questions
 * Used AFTER generation to verify factual accuracy with Google Search
 */
...
/**
 * Prompt for batch fact-checking multiple questions at once
 * More efficient for checking several questions in one API call
 */
export const FACT_CHECK_BATCH_PROMPT = `Tu es un vérificateur de faits STRICT et RIGOUREUX.
Ta mission : vérifier si les réponses à plusieurs questions sont 100% CORRECTES.
...
RÈGLES DE CONFIANCE :
- 95-100 : Fait vérifié, aucun doute
- 80-94 : Probablement correct
- 60-79 : Doute significatif
- 0-59 : Probablement faux

Pas de markdown. JSON uniquement.`;

/**
 * Prompt for Phase 2 specific fact-checking (verifying item categorization)
 * Checks if items are correctly assigned to category A, B, or Both
 */
